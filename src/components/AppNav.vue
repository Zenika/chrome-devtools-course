...
<template>
  <div class="wrapper">
    <nav>
      ...
      <RouterLink :ref="(el) => links.push(el)" to="/elements" class="router-link"
        >Elements</RouterLink
      >
      <RouterLink :ref="(el) => links.push(el)" to="/console" class="router-link"
        >Console</RouterLink
      >
      <RouterLink :ref="(el) => links.push(el)" to="/sources" class="router-link"
        >Sources</RouterLink
      >
      <RouterLink :ref="(el) => links.push(el)" to="/network" class="router-link"
        >Network</RouterLink
      >
      <RouterLink :ref="(el) => links.push(el)" to="/performance" class="router-link"
        >Performance</RouterLink
      >
      <RouterLink :ref="(el) => links.push(el)" to="/lighthouse" class="router-link"
        >Lighthouse</RouterLink
      >
