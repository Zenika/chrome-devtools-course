...
const dontClick = () => {
  ...
  console.log('%cExemple %s', css, 'la ça pique les yeux')
  console.log(
    '%cEt là aussi',
    'background-color: fuchsia ; color: white ; font-weight: bold ; ' +
      'font-size: 40px ; font-style: italic ; text-decoration: underline ; ' +
      "font-family: 'american typewriter' ; text-shadow: 1px 1px 3px black ; padding: 10px"
  )
}
...
<template>
  ...
  <PixelButton text="Don't print" @click="dontClick" />
</template>
